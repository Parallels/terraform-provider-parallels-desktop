...
func GetClaims(ctx context.Context, config HostConfig, filterField, filterValue string) ([]apimodels.ClaimRoleResponse, diag.Diagnostics) {
	...
	tflog.Info(ctx, "Got "+strconv.Itoa(len(response))+" claims")
