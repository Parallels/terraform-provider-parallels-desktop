...
type ParallelsServerInfo struct {
	ID                           string                                 `json:"ID"`
	...
	MemoryLimit                  ParallelsServerMemoryLimit             `json:"Memory limit"`
	...
	License                      ParallelsServerLicense                 `json:"License"`
	HardwareID                   string                                 `json:"Hardware Id"`
	SignedIn                     string                                 `json:"Signed In"`
	HardwareInfo                 map[string]ParallelsServerHardwareInfo `json:"Hardware info"`
}

type ParallelsServerHardwareInfo struct {
	Name string `json:"name"`
	Type string `json:"type"`
}

type ParallelsServerLicense struct {
	State      string `json:"state"`
	Key        string `json:"key"`
	Restricted string `json:"restricted"`
}

type ParallelsServerMemoryLimit struct {
